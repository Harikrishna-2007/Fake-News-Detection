    ...
    >
      ...
      <section className="relative overflow-hidden pt-20 pb-24 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p
            ...
            style={{ color: 'var(--muted-foreground)' }}
          >
            Paste any news article or headline and get an instant AI-powered verdict — REAL or FAKE
            — backed by TF-IDF vectorization and Logistic Regression trained on 44,000+ labeled
            articles.
          </p>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats?.map((s) => (
            <div key={s?.label} className="text-center">
              ...
              <div className="text-xs font-500 mt-0.5" style={{ color: 'var(--muted-foreground)' }}>
                {s?.label}
              </div>
            </div>
          ))}
              ...
              {recentDetections?.map((item, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p
                      className="text-sm font-500 leading-snug"
                      style={{ color: 'var(--foreground)' }}
                    >
                      {item?.headline}
                    </p>
            ...
            <div className="space-y-4">
              {features?.map((f, i) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-sm font-700 mb-1" style={{ color: 'var(--foreground)' }}>
                      {f?.title}
                    </h3>
                    <p
      ...
      <footer className="border-t py-8 px-6 text-center" style={{ borderColor: 'var(--border)' }}>
        <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>
          © 2026 FakeNewsDetector · B.E CSE (AI&ML) · V.S.B Engineering College · Built with Next.js
